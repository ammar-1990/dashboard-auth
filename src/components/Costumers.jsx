      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell className='tableCell' align="left">Method</TableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell className='tableCell' align="left"><div className="productWraper">{<img src={row.img} alt="" />}{row.product}</div></TableCell>
              ...
              <TableCell className='tableCell' align="left"><span className={`status ${row.status}`}>{row.status}</span></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
